...
| [ADR-0014 — Anonymous review publication](0014-v009-anonymous-review-publication.md) | Accepted | Publication identity is independent from verification; CRM consent, safe public projection, auditability, and re-moderation rules |
| [ADR-0015 — Reporting v1 scope and semantics](0015-reporting-v1-scope-and-semantics.md) | Accepted | Existing-data reporting, fulfillment and cash semantics, filters, privacy coverage, dashboard priorities, and phase-two exclusions |
