...
export const shops = sqliteTable("shops", {
  ...
  storefrontTheme: text("storefront_theme", { enum: ["forest-harvest", "nordic-ink", "berry-season", "arctic-mist", "midnight-spruce"] }).notNull().default("forest-harvest"),
...
export const storefrontThemeVersions = sqliteTable(
  "storefront_theme_versions",
  {
    ...
    themeKey: text("theme_key", { enum: ["forest-harvest", "nordic-ink", "berry-season", "arctic-mist", "midnight-spruce"] }).notNull(),
...
export const customers = sqliteTable(
  "customers",
  {
    ...
    contactConfirmedBy: text("contact_confirmed_by"),
    contactConfirmationChannel: text("contact_confirmation_channel"),
    contactConfirmationNote: text("contact_confirmation_note"),
    contactConfirmationExpiresAt: text("contact_confirmation_expires_at"),
    retentionHoldUntil: text("retention_hold_until"),
    retentionHoldReason: text("retention_hold_reason"),
    retentionHoldSetBy: text("retention_hold_set_by"),
    createdAt: text("created_at").notNull(),
    updatedAt: text("updated_at").notNull(),
  },
...
export const reviews = sqliteTable(
  "reviews",
  {
    ...
    publicNameConsentAt: text("public_name_consent_at"),
    publicNameConsentSource: text("public_name_consent_source"),
    publicNameConsentNote: text("public_name_consent_note"),
    publicNameConsentBy: text("public_name_consent_by"),
...
export const availability = sqliteTable(
  ...
  (table) => [
    ...
    uniqueIndex("availability_shop_product_legacy_date_unique").on(
      table.shopId,
      table.productId,
      table.businessDate,
