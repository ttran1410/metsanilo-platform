      ...
      <section id="catalog" className="shell storefront-section catalog-section" aria-labelledby="catalog-title">
        ...
        <div className="catalog-grid">{products.map((product, productIndex) => {
          ...
          <div className="catalog-content">
            ...
            {available ? <a className="btn btn-accent" href={`/${locale}/reserve?product=${encodeURIComponent(product.id)}`}>{locale === "fi" ? "Varaa tämä tuote" : "Reserve this product"}<span aria-hidden="true">→</span></a> : <span className="btn btn-disabled" aria-disabled="true">{availabilityLabels[locale][productStatus]}</span>}
          </div>
