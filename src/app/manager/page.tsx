...
export default async function ManagerPage() {
  ...
  return <><ManagerView initialOrders={orders} initialAvailability={availability} /><div className="shell pb-10"><ProductModule initialProducts={products} /></div><UserModule /></>;
}
