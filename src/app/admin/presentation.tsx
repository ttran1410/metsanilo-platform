...
export { AdminCard, AdminConfirmDialog, AdminDataTable, AdminFeedback, AdminFieldError, AdminFilterBar, AdminPermissionGate, AdminRecordCard, AdminSelectionToolbar, AdminStatusBadge, AdminTimeline, formatAdminMoney, formatAdminReference } from "./ui/primitives";
